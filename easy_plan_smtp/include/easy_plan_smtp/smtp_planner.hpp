...
#ifndef EASY_PLAN__SMTP_PLANNER_HPP_
#define EASY_PLAN__SMTP_PLANNER_HPP_
...
public:
  ...
  /**
   * @brief Generates a plan using the SMTP algorithm.
...
#endif // EASY_PLAN__SMTP_PLANNER_HPP_