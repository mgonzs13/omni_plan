...
#ifndef OMNI_PLAN_YASMIN__YASMIN_FACTORY_ACTION_HPP_
#define OMNI_PLAN_YASMIN__YASMIN_FACTORY_ACTION_HPP_
 ...
 * with OmniPlan's Action interface.
 */
class YasminFactoryAction : public omni_plan::pddl::Action {
public:
  /**
...
private:
  ...
  yasmin::StateMachine::SharedPtr state_machine_;
...
#endif // OMNI_PLAN_YASMIN__YASMIN_FACTORY_ACTION_HPP_