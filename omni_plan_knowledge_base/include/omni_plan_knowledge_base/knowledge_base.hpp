...
#ifndef OMNI_PLAN_KNOWLEDGE_BASE__KNOWLEDGE_BASE_HPP_
#define OMNI_PLAN_KNOWLEDGE_BASE__KNOWLEDGE_BASE_HPP_
...
public:
   ...
   */
  bool has_object(const omni_plan::pddl::Object &object) const;
   ...
   */
  bool has_predicate(const omni_plan::pddl::Predicate &predicate) const;
   ...
   */
  bool has_fact(const omni_plan::pddl::Predicate &fact) const;
   ...
   */
  bool has_goal(const omni_plan::pddl::Predicate &goal) const;
...
private:
  ...
  /// Set of objects.
  std::set<omni_plan::pddl::Object> objects_;

  /// Set of predicate definitions.
  std::set<omni_plan::pddl::Predicate> predicates_;

  /// Set of facts (ground predicates that are true).
  std::set<omni_plan::pddl::Predicate> facts_;

  /// Set of goals (predicates to be achieved).
  std::set<omni_plan::pddl::Predicate> goals_;
};

} // namespace omni_plan_knowledge_base

#endif // OMNI_PLAN_KNOWLEDGE_BASE__KNOWLEDGE_BASE_HPP_
