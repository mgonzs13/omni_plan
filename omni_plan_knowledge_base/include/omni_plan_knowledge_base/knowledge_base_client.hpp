...
public:
   ...
   * @return True if successful, false otherwise.
   */
  bool add_object(const omni_plan::pddl::Object &object);
   ...
   * @return True if successful, false otherwise.
   */
  bool add_objects(const std::vector<omni_plan::pddl::Object> &objects);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_object(const omni_plan::pddl::Object &object);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_objects(const std::vector<omni_plan::pddl::Object> &objects);

  /**
   * @brief Gets all objects from the knowledge base.
   * @return A vector of all objects.
   */
  std::vector<omni_plan::pddl::Object> get_objects();
   ...
   * @return True if successful, false otherwise.
   */
  bool add_predicate(const omni_plan::pddl::Predicate &predicate);
   ...
   */
  bool
  add_predicates(const std::vector<omni_plan::pddl::Predicate> &predicates);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_predicate(const omni_plan::pddl::Predicate &predicate);
   ...
   */
  bool
  remove_predicates(const std::vector<omni_plan::pddl::Predicate> &predicates);

  /**
   * @brief Gets all predicate definitions from the knowledge base.
   * @return A vector of all predicates.
   */
  std::vector<omni_plan::pddl::Predicate> get_predicates();
   ...
   * @return True if successful, false otherwise.
   */
  bool add_fact(const omni_plan::pddl::Predicate &fact);
   ...
   * @return True if successful, false otherwise.
   */
  bool add_facts(const std::vector<omni_plan::pddl::Predicate> &facts);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_fact(const omni_plan::pddl::Predicate &fact);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_facts(const std::vector<omni_plan::pddl::Predicate> &facts);
   ...
   * @return True if successful, false otherwise.
   */
  bool add_goal(const omni_plan::pddl::Predicate &goal);
   ...
   * @return True if successful, false otherwise.
   */
  bool add_goals(const std::vector<omni_plan::pddl::Predicate> &goals);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_goal(const omni_plan::pddl::Predicate &goal);
   ...
   * @return True if successful, false otherwise.
   */
  bool remove_goals(const std::vector<omni_plan::pddl::Predicate> &goals);

  /**
   * @brief Gets all goals from the knowledge base.
   * @return A vector of all goals.
   */
  std::vector<omni_plan::pddl::Predicate> get_goals();
...
private:
   ...
   */
  omni_plan_msgs::msg::Object
  object_to_msg(const omni_plan::pddl::Object &object) const;
   ...
   */
  omni_plan_msgs::msg::Predicate
  predicate_to_msg(const omni_plan::pddl::Predicate &predicate) const;
  ...
  rclcpp::Client<omni_plan_msgs::srv::GetTypes>::SharedPtr get_types_client_;
  /// @brief Service client for adding a type.
  rclcpp::Client<omni_plan_msgs::srv::AddType>::SharedPtr add_type_client_;
  /// @brief Service client for adding multiple types.
  rclcpp::Client<omni_plan_msgs::srv::AddTypes>::SharedPtr add_types_client_;
  /// @brief Service client for removing a type.
  rclcpp::Client<omni_plan_msgs::srv::RemoveType>::SharedPtr
      remove_type_client_;
  /// @brief Service client for removing multiple types.
  rclcpp::Client<omni_plan_msgs::srv::RemoveTypes>::SharedPtr
      remove_types_client_;

  /// @brief Service client for getting objects.
  rclcpp::Client<omni_plan_msgs::srv::GetObjects>::SharedPtr
      get_objects_client_;
  /// @brief Service client for adding an object.
  rclcpp::Client<omni_plan_msgs::srv::AddObject>::SharedPtr add_object_client_;
  /// @brief Service client for adding multiple objects.
  rclcpp::Client<omni_plan_msgs::srv::AddObjects>::SharedPtr
      add_objects_client_;
  /// @brief Service client for removing an object.
  rclcpp::Client<omni_plan_msgs::srv::RemoveObject>::SharedPtr
      remove_object_client_;
  /// @brief Service client for removing multiple objects.
  rclcpp::Client<omni_plan_msgs::srv::RemoveObjects>::SharedPtr
      remove_objects_client_;

  /// @brief Service client for getting predicates.
  rclcpp::Client<omni_plan_msgs::srv::GetPredicates>::SharedPtr
      get_predicates_client_;
  /// @brief Service client for adding a predicate.
  rclcpp::Client<omni_plan_msgs::srv::AddPredicate>::SharedPtr
      add_predicate_client_;
  /// @brief Service client for adding multiple predicates.
  rclcpp::Client<omni_plan_msgs::srv::AddPredicates>::SharedPtr
      add_predicates_client_;
  /// @brief Service client for removing a predicate.
  rclcpp::Client<omni_plan_msgs::srv::RemovePredicate>::SharedPtr
      remove_predicate_client_;
  /// @brief Service client for removing multiple predicates.
  rclcpp::Client<omni_plan_msgs::srv::RemovePredicates>::SharedPtr
      remove_predicates_client_;

  /// @brief Service client for getting facts.
  rclcpp::Client<omni_plan_msgs::srv::GetFacts>::SharedPtr get_facts_client_;
  /// @brief Service client for adding a fact.
  rclcpp::Client<omni_plan_msgs::srv::AddFact>::SharedPtr add_fact_client_;
  /// @brief Service client for adding multiple facts.
  rclcpp::Client<omni_plan_msgs::srv::AddFacts>::SharedPtr add_facts_client_;
  /// @brief Service client for removing a fact.
  rclcpp::Client<omni_plan_msgs::srv::RemoveFact>::SharedPtr
      remove_fact_client_;
  /// @brief Service client for removing multiple facts.
  rclcpp::Client<omni_plan_msgs::srv::RemoveFacts>::SharedPtr
      remove_facts_client_;

  /// @brief Service client for getting goals.
  rclcpp::Client<omni_plan_msgs::srv::GetGoals>::SharedPtr get_goals_client_;
  /// @brief Service client for adding a goal.
  rclcpp::Client<omni_plan_msgs::srv::AddGoal>::SharedPtr add_goal_client_;
  /// @brief Service client for adding multiple goals.
  rclcpp::Client<omni_plan_msgs::srv::AddGoals>::SharedPtr add_goals_client_;
  /// @brief Service client for removing a goal.
  rclcpp::Client<omni_plan_msgs::srv::RemoveGoal>::SharedPtr
      remove_goal_client_;
  /// @brief Service client for removing multiple goals.
  rclcpp::Client<omni_plan_msgs::srv::RemoveGoals>::SharedPtr
      remove_goals_client_;

  /// @brief Service client for clearing the knowledge base.
  rclcpp::Client<omni_plan_msgs::srv::ClearKnowledgeBase>::SharedPtr
      clear_client_;
...
#endif // OMNI_PLAN_KNOWLEDGE_BASE__KNOWLEDGE_BASE_CLIENT_HPP_
