...
#include "omni_plan_knowledge_base/knowledge_base_exceptions.hpp"
...
void KnowledgeBaseNode::publish_knowledge_update(int8_t operation,
                                                 int8_t entity_type) {
  omni_plan_msgs::msg::KnowledgeUpdate update_msg;
...
void KnowledgeBaseNode::add_type_callback(
  ...
  if (response->success) {
    ...
    this->publish_knowledge_update(omni_plan_msgs::msg::KnowledgeUpdate::ADD,
                                   omni_plan_msgs::msg::KnowledgeUpdate::TYPE);
  }
}
  ...
  try {
    ...
    if (response->success) {
      ...
      this->publish_knowledge_update(
          omni_plan_msgs::msg::KnowledgeUpdate::ADD,
          omni_plan_msgs::msg::KnowledgeUpdate::OBJECT);
    }

  } catch (const omni_plan_knowledge_base::TypeNotFoundException &e) {
...
void KnowledgeBaseNode::remove_object_callback(
  ...
  if (response->success) {
    // Publish knowledge update
    this->publish_knowledge_update(
        omni_plan_msgs::msg::KnowledgeUpdate::REMOVE,
        omni_plan_msgs::msg::KnowledgeUpdate::OBJECT);
  }
}
...
void KnowledgeBaseNode::add_predicate_callback(
  ...
  try {
    ...
    if (response->success) {
      ...
      this->publish_knowledge_update(
          omni_plan_msgs::msg::KnowledgeUpdate::ADD,
          omni_plan_msgs::msg::KnowledgeUpdate::PREDICATE);
    }
...
void KnowledgeBaseNode::add_fact_callback(
  ...
  try {
    ...
    if (response->success) {
      ...
      this->publish_knowledge_update(
          omni_plan_msgs::msg::KnowledgeUpdate::ADD,
          omni_plan_msgs::msg::KnowledgeUpdate::FACT);
    }

  } catch (const omni_plan_knowledge_base::PredicateNotFoundException &e) {
...
void KnowledgeBaseNode::add_goal_callback(
  ...
  try {
    ...
    if (response->success) {
      ...
      this->publish_knowledge_update(
          omni_plan_msgs::msg::KnowledgeUpdate::ADD,
          omni_plan_msgs::msg::KnowledgeUpdate::GOAL);
    }
...
void KnowledgeBaseNode::remove_objects_callback(
    const std::shared_ptr<omni_plan_msgs::srv::RemoveObjects::Request> request,
...
void KnowledgeBaseNode::add_predicates_callback(
    const std::shared_ptr<omni_plan_msgs::srv::AddPredicates::Request> request,
...
void KnowledgeBaseNode::remove_predicates_callback(
    const std::shared_ptr<omni_plan_msgs::srv::RemovePredicates::Request>
        request,
    std::shared_ptr<omni_plan_msgs::srv::RemovePredicates::Response> response) {
  response->success = true;
  for (const auto &pred_msg : request->predicates) {
    auto pred = this->msg_to_predicate(pred_msg);
...
KnowledgeBaseNode::msg_to_object(const omni_plan_msgs::msg::Object &msg) const {
  return omni_plan::pddl::Object(msg.name, msg.type);
}

omni_plan::pddl::Predicate KnowledgeBaseNode::msg_to_predicate(
    const omni_plan_msgs::msg::Predicate &msg) const {
  std::vector<std::string> args(msg.arguments.begin(), msg.arguments.end());
  return omni_plan::pddl::Predicate(msg.name, args, msg.negated);
}
