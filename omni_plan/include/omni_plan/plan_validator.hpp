...
#ifndef OMNI_PLAN__PLAN_VALIDATOR_HPP_
#define OMNI_PLAN__PLAN_VALIDATOR_HPP_
 ...
 * achieves the goals.
 */
class PlanValidator : public utils::ParameterLoader {
public:
  /**
...
#endif // OMNI_PLAN__PLAN_VALIDATOR_HPP_