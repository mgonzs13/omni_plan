...
#ifndef OMNI_PLAN__PDDL_MANAGER_HPP_
#define OMNI_PLAN__PDDL_MANAGER_HPP_
...
public:
   ...
   */
  virtual bool
  predicate_is_goal(const omni_plan::pddl::Predicate &predicate) const = 0;
...
#endif // OMNI_PLAN__PDDL_MANAGER_HPP_