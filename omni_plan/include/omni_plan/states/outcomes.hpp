...
#ifndef OMNI_PLAN__STATES__OUTCOMES_HPP_
#define OMNI_PLAN__STATES__OUTCOMES_HPP_

/**
 * @file outcomes.hpp
 * @brief Defines string constants for state machine outcomes in the omni_plan
 * framework.
...
#endif // OMNI_PLAN__STATES__OUTCOMES_HPP_