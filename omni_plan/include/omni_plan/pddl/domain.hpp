...
#ifndef OMNI_PLAN__PDDL__DOMAIN_HPP_
#define OMNI_PLAN__PDDL__DOMAIN_HPP_
...
#include "omni_plan_msgs/msg/domain.hpp"
...
public:
   ...
   */
  const std::map<std::string, std::shared_ptr<Action>> &get_actions() const {
   ...
   * @return An omni_plan_msgs::msg::Domain message representing the domain.
   */
...
#endif // OMNI_PLAN__PDDL__DOMAIN_HPP_
