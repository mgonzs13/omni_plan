...
#ifndef OMNI_PLAN__PDDL__PREDICATE_HPP_
#define OMNI_PLAN__PDDL__PREDICATE_HPP_
...
public:
   ...
   * predicate.
   */
  virtual omni_plan_msgs::msg::Predicate to_msg() const;
...
#endif // OMNI_PLAN__PDDL__PREDICATE_HPP_
