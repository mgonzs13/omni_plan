...
#ifndef OMNI_PLAN__PDDL__ACTION_HPP_
#define OMNI_PLAN__PDDL__ACTION_HPP_
...
#include "omni_plan_msgs/msg/action.hpp"
...
public:
   ...
   * @return A ROS message of type omni_plan_msgs::msg::Action representing the
   * action.
   */
  omni_plan_msgs::msg::Action to_msg() const;
...
#endif // OMNI_PLAN__PDDL__ACTION_HPP_