...
omni_plan_msgs::msg::Predicate TimingPredicate::to_msg() const {
  omni_plan_msgs::msg::Predicate msg = Predicate::to_msg();
  switch (this->type_) {
  case START:
    msg.time = omni_plan_msgs::msg::Predicate::AT_START;
    break;
  case OVER_ALL:
