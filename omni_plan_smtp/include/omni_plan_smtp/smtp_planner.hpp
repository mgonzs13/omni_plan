...
#ifndef OMNI_PLAN_SMTP__SMTP_PLANNER_HPP_
#define OMNI_PLAN_SMTP__SMTP_PLANNER_HPP_
 ...
 */
class SmtpPlanner : public omni_plan::Planner {
public:
  /**
...
#endif // OMNI_PLAN_SMTP__SMTP_PLANNER_HPP_