...
protected:
  ...
  omni_plan::pddl::Effect create_effect(const std::string &name,
                                        const std::vector<std::string> &args,
                                        bool negated = false) {
    omni_plan::pddl::Effect effect(omni_plan::pddl::END, name, args, negated);
    return effect;
  }
...
TEST_F(KgPddlManagerTest, PredicateExistsReturnsTrueForExistingEdge) {
  ...
  omni_plan::pddl::Predicate predicate("at", {"robot1", "loc1"});
...
TEST_F(KgPddlManagerTest, PredicateExistsWithSingleArgument) {
  ...
  omni_plan::pddl::Predicate predicate("charging", {"robot1"});
  EXPECT_TRUE(manager_->predicate_exists(predicate));
}
...
TEST_F(KgPddlManagerTest, PredicateExistsReturnsFalseForWrongEdgeClass) {
  ...
  omni_plan::pddl::Predicate predicate("near", {"robot1", "loc1"});
  EXPECT_FALSE(manager_->predicate_exists(predicate));
}
...
TEST_F(KgPddlManagerTest, PredicateExistsWithMultipleEdges) {
  ...
  omni_plan::pddl::Predicate predicate_at("at", {"robot1", "loc1"});
  omni_plan::pddl::Predicate predicate_near("near", {"robot1", "loc1"});
  omni_plan::pddl::Predicate predicate_far("far", {"robot1", "loc1"});
...
TEST_F(KgPddlManagerTest, PredicateIsGoalReturnsTrueForGoalEdge) {
  ...
  omni_plan::pddl::Predicate predicate("at", {"robot1", "loc2"});
...
TEST_F(KgPddlManagerTest, PredicateIsGoalWithSingleArgument) {
  ...
  omni_plan::pddl::Predicate predicate("charged", {"robot1"});
  EXPECT_TRUE(manager_->predicate_is_goal(predicate));
}
...
TEST_F(KgPddlManagerTest, PredicateIsGoalReturnsFalseForWrongEdgeClass) {
  ...
  omni_plan::pddl::Predicate predicate("near", {"robot1", "loc2"});
  EXPECT_FALSE(manager_->predicate_is_goal(predicate));
}
...
TEST_F(KgPddlManagerTest, PredicateIsGoalWithMultipleEdges) {
  ...
  omni_plan::pddl::Predicate predicate_loc1("at", {"robot1", "loc1"});
  omni_plan::pddl::Predicate predicate_loc2("at", {"robot1", "loc2"});
...
TEST_F(KgPddlManagerTest, PredicateExistsAndIsGoalCombinedScenario) {
  ...
  omni_plan::pddl::Predicate pred_loc1("at", {"robot1", "loc1"});
