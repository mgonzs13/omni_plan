...
#ifndef OMNI_PLAN_KNOWLEDGE_GRAPH__KG_PDDL_MANAGER_HPP_
#define OMNI_PLAN_KNOWLEDGE_GRAPH__KG_PDDL_MANAGER_HPP_
...
namespace omni_plan_knowledge_graph {
 ...
 */
class KgPddlManager : public omni_plan::PddlManager {
public:
  /**
   ...
   */
  bool
  predicate_exists(const omni_plan::pddl::Predicate &predicate) const override;
   ...
   */
  bool
  predicate_is_goal(const omni_plan::pddl::Predicate &predicate) const override;
...
#endif // OMNI_PLAN_KNOWLEDGE_GRAPH__KG_PDDL_MANAGER_HPP_