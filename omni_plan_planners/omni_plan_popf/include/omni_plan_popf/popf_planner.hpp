...
#ifndef OMNI_PLAN_POPF__POPF_PLANNER_HPP_
#define OMNI_PLAN_POPF__POPF_PLANNER_HPP_
 ...
 */
class PopfPlanner : public omni_plan::Planner {
public:
  /**
...
#endif // OMNI_PLAN_POPF__POPF_PLANNER_HPP_