...
#ifndef OMNI_PLAN_VAL__VAL_VALIDATOR_HPP_
#define OMNI_PLAN_VAL__VAL_VALIDATOR_HPP_
 ...
 */
class ValValidator : public omni_plan::PlanValidator {
public:
  /**
  ...
  /// @brief Make the base class overload set visible; the path-based override
  /// below would otherwise hide validate_plan(Domain, Problem, Plan).
  using omni_plan::PlanValidator::validate_plan;
...
#endif // OMNI_PLAN_VAL__VAL_VALIDATOR_HPP_