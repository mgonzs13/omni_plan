 ...
 */
class MockMoveAction : public omni_plan::pddl::Action {
public:
  MockMoveAction()
      : Action("move", {{"robot", "robot"}, {"r1", "room"}, {"r2", "room"}}) {
    // Conditions
    add_condition(omni_plan::pddl::Type::START, "robot_at", {"robot", "r1"});
    add_condition(omni_plan::pddl::Type::START, "connected", {"r1", "r2"});

    // Effects
    add_effect(omni_plan::pddl::Type::START, "robot_at", {"robot", "r1"}, true);
    add_effect(omni_plan::pddl::Type::END, "robot_at", {"robot", "r2"});
  }
...
PLUGINLIB_EXPORT_CLASS(omni_plan_tests::MockMoveAction, omni_plan::pddl::Action)
